...
%CALL SOLUTION
disp('COMPUTING!!!');
[Fss,FLHss,FRHss] = dd_fsys_jm_1_13_2016(Xss,Xss,etass,epsss); 
...
for Xct=1:numstates;
   ...
   X(Xct) = X(Xct)+h;
   F = dd_fsys_jm_1_13_2016(X,Xss,etass,epsss);
   F1(:,Xct) =(F-Fss)/h;
end
...
for Xmin1ct=1:numstates;
   ...
   F = dd_fsys_jm_1_13_2016(Xss,Xmin1,etass,epsss);
   F2(:,Xmin1ct) = (F-Fss)/h;
end
...
for etact=1:numetas;
   ...
   F = dd_fsys_jm_1_13_2016(Xss,Xss,eta,epsss);
   F3(:,etact) = (F-Fss)/h;
end
...
for epsct = 1:numeps;
    ...
    F = dd_fsys_jm_1_13_2016(Xss,Xss,etass,eps);
    F4(:,epsct) = (F-Fss)/h;
end
